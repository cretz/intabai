...
function patch(src) {
    ...
    // TEMP: MatMul fp32-acc edits 1-8 disabled for blockiness experiment.
    // Restore by uncommenting the block below and removing this comment.
    if (matmulPatched) {
    ...
    // TEMP: Softmax fp32-acc edits 10-16 disabled for blockiness experiment.
    // Restore by uncommenting the block below and removing this comment.
